	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					ngrok creates a secure tunnel so Ditto can reach your local
					server. A free ngrok account is all you need.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<div className="flex flex-col gap-5">
					...
					<Input
						...
						description="If you have a reserved ngrok domain, enter it here for a stable URL"
